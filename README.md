...
4. Open your code editor (for example Visual Studio on windows) -> choose "open local folder" (or similar) -> choose path to folder with this project -> open that folder in code editor (don't open only CMakelists file, it won't work)  
